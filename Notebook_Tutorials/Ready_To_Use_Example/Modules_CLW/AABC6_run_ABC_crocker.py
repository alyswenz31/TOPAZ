...
def run_ABC_crocker_aabc(C_idx,L_idx,W_idx,T0,TF,DT,in_num_agents):
    #VANILLA CROCKER
    ...
    # load median values
    median_path = './Chosen_C_'+str(C_idx).zfill(2)+'_L_'+str(L_idx).zfill(2)+'_W_'+str(W_idx).zfill(2)+'/medians_aabc.npy'
    medians = np.load(median_path,allow_pickle=True)

    # Get ABC results:
    ABC_path = './Chosen_C_'+str(C_idx).zfill(2)+'_L_'+str(L_idx).zfill(2)+'_W_'+str(W_idx).zfill(2)+'/df_AABC.pkl'
    ...
    plot_crocker_highres_split(ABC_crocker,
                               ...
                               [50,150,250,350,450],
                               medians,
                               save_path='./Chosen_C_'+str(C_idx).zfill(2)+'_L_'+str(L_idx).zfill(2)+'_W_'+str(W_idx).zfill(2)+'/AABC_crocker.png')
