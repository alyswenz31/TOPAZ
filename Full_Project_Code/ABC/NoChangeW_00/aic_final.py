...
def BIC_fun(Cidx, Lidx, Widx, CLW_path):
    ...
    # put it all together into AIC
    AIC = 2*k - 2*Log_L

    return [AIC, RSS]

pars_idc = [(17,3,0),(6,24,0),(19,0,0),(8,5,0),(4,4,0),(1,14,0),(14,6,0),(24,24,0),(19,14,0),(17,3,5),(6,24,5),(19,0,5),(11,6,0),(8,5,5),(4,4,5),(1,14,5),(14,6,5),(24,24,5),(19,14,5),(11,6,5)]
...
for pars_idx in pars_idc:
    ...
    AIC_results = BIC_fun(Cidx, Lidx, Widx, CLW_path)
    np.save(CLW_path + '/aic_results.npy',AIC_results)
    np.savetxt(CLW_path+'/aic_results.txt', AIC_results, delimiter=",") 
