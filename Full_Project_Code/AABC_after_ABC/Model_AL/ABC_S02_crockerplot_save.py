...
def run_save_crocker(args):
    ...
    DF_PATH = './sample_'+str(NUM_SAMPLE)+'/run_'+str(iSample+1)+'/df.pkl'
    unscale_num = 25
    #read in the dataframe and filter positions
    if os.path.exists('./sample_'+str(NUM_SAMPLE)+'/run_'+str(iSample+1)+'/crocker_angles.npy'):
        pass
    else:
        ...
        if 'vx' in DATA_COLS:
            SAVE_PATH = './sample_'+str(NUM_SAMPLE)+'/run_'+str(iSample+1)+'/crocker_velocities.npy'
        if 'angle' in DATA_COLS:
            SAVE_PATH = './sample_'+str(NUM_SAMPLE)+'/run_'+str(iSample+1)+'/crocker_angles.npy'
