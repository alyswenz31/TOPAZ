...
from Scripts.DorsognaNondim_Align_w00 import *
...
for pars_idx in pars_idc:
    ...
    plot_crocker_highres_split(ABC_crocker,
                               ...
                               [50,150,250,350,450],
                               medians,
                               save_path='./Simulated_Grid/ODE_Align/Cidx_'+str(Cidx).zfill(2)+'_Lidx_'+str(Lidx).zfill(2)+'_Widx_'+str(Widx).zfill(2)+'/run_1/ABC_crocker_'+'Cidx_'+str(Cidx).zfill(2)+'_Lidx_'+str(Lidx).zfill(2)+'_Widx_'+str(Widx).zfill(2)+'_angles_OGw00.pdf')
